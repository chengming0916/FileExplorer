...
namespace TestApp
{
    ...
    public class AppViewModel : Screen, IHandle<RootChangedEvent>//, IHandle<SelectionChangedEvent>
    {
        ...
        {
            RootModels.Clear();
            _events.PublishOnUIThreadAsync(new RootChangedEvent(ChangeType.Changed, RootModels.ToArray()));
        }
        ...
        public void Remove()
        {
            ...
            {
                _events.PublishOnUIThreadAsync(new RootChangedEvent(ChangeType.Deleted, SelectedRootModel));
        ...
        private void pickAndAdd(IEntryModel[] rootModel)
        {
            ...
            _events.PublishOnUIThreadAsync(new RootChangedEvent(ChangeType.Created, selectedModel));
        }
